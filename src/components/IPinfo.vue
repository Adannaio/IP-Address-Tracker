<template>
  <div class="absolute divide-x-2 divide-black divide-opacity-10  -bottom-64 lg:-bottom-20 flex flex-col lg:flex-row bg-white gap-y-4 gap-x-12 px-8 pt-8 pb-12 rounded-md">
